...
import { useGenerateMd } from "shared/hooks";
import { useAppStore } from "entities/store/app.store";
import CustomTabs from "shared/ui/CustomTabs";
import DevSocialPreview from "features/dev-social/ui/Preview";
import IconPreview from "features/icon/ui/Preview";
import ImagePreview from "features/image/ui/Preview";
import QuotePreview from "features/quote/ui/Preview";
import StatsPreview from "features/stats/ui/Preview";
import TextPreview from "features/text/ui/Preview";
import ViewsPreview from "features/views/ui/Preview";
  ...
  return (
    <footer class="flex items-center justify-between py-2.5 px-4">
      <p class="text-white/80 font-medium text-xs">
        &#169; {new Date().getFullYear()} README prettier
      </p>
      <a
        href="https://github.com/phanmhung/readme-prettier"
        target="_blank"
